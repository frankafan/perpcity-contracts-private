...
/// @title PoolManagerMock
/// @notice Mock of PoolManager for Halmos testing - identical to real PoolManager except uses TickMathSimplified
contract PoolManagerMock is IPoolManager, ProtocolFees, NoDelegateCall, ERC6909Claims, Extsload, Exttload {
    using SafeCast for *;
    using Pool for *;
