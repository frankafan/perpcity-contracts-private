...
uint24 constant PRICE_IMPACT_BAND = 0.1e6; // 10%
uint24 constant MIN_OPENING_MARGIN = 1e6; // 1 USDC
uint24 constant MIN_MAKER_OPENING_MARGIN_RATIO = 1e6; // 100% / 1x leverage
uint24 constant MAX_MAKER_OPENING_MARGIN_RATIO = 4e6; // 400% / 0.25x leverage
...
uint24 constant TAKER_LIQUIDATION_MARGIN_RATIO = 0.05e5; // 5% / 20x leverage
